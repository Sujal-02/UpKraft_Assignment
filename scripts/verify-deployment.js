...
console.log('\n' + '='.repeat(50));
console.log(allPassed ? '🎉 All checks passed! Ready to deploy.' : '⚠️  Some checks failed. Fix issues above.');
console.log('='.repeat(50));

if (allPassed) {
  console.log('\n📋 Next Steps:');
  console.log('1. Commit and push changes: git add . && git commit -m "Deploy" && git push');
  console.log('2. Enable GitHub Pages: Settings → Pages → Source: GitHub Actions');
